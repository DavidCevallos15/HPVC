...
export default function NoticiaDetallePage() {
  ...
  if (loading) return (
    <div className="container mx-auto px-6 py-20 max-w-3xl">
      <div className="h-64 bg-neutral-100 rounded-card animate-pulse mb-6" />
      <div className="space-y-3">{[...Array(6)].map((_, i) => <div key={i} className="h-4 bg-neutral-100 rounded animate-pulse" />)}</div>
    </div>
  );
  ...
  if (error || !noticia) return (
    <div className="container mx-auto px-6 py-20 text-center">
      ...
      <h2 className="text-2xl font-semibold text-dark mb-2">Noticia no encontrada</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-light">
      ...
      <article className="container mx-auto px-6 py-10 max-w-3xl">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold font-heading text-dark leading-tight mb-4">{noticia.titulo || 'Sin Título'}</h1>
