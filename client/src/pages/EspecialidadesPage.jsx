      ...
      <div className="bg-neutral-50 border-b border-neutral-200">
        <div className="container mx-auto px-4 sm:px-6 py-10 md:py-12">
          <div className="text-center mb-8 md:mb-10">
            <h2 className="text-2xl md:text-3xl font-semibold font-heading text-dark mb-3 md:mb-4">Cartera de Servicios Institucional</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-6 max-w-6xl mx-auto">
            {[{
              ...
              <div key={categoria.titulo} className="bg-white p-5 md:p-6 rounded-card shadow-sm border border-neutral-100 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-4">
                  <div className="size-10 md:size-12 bg-primary-pale rounded-xl flex items-center justify-center shrink-0">
                    {categoria.icono}
                  </div>
                  <h3 className="font-semibold text-base md:text-lg text-dark leading-tight">{categoria.titulo}</h3>
                </div>
                <ul className="space-y-2.5 md:space-y-3">
                  {categoria.items.map((item) => (
                    <li key={item} className="flex items-start gap-2.5 text-xs md:text-sm text-gray">
